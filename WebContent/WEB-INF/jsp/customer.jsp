...
<%@ taglib prefix="itcast" uri="http://rongyuez/common/"%>
<%
	...
	<script type="text/javascript">
		function editCustomer(id) {
			$.ajax({
				...
				success:function(data) {
					...
					$("#edit_customerFrom").val(data.cust_source_id);
					$("#edit_custIndustry").val(data.cust_industry_id);
					$("#edit_custLevel").val(data.cust_level_id);
		...
		function deleteCustomer(id) {
			if(confirm('确实要删除该客户吗?')) {
				$.get("<%=basePath%>customer/delete/" + id ,function(data){
					alert("客户删除更新成功！");
					window.location.reload();
				});
			}
